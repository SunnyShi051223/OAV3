...
export const applicationApi = {
  ...
  all: () => request.get('/applications/all'),
...
export const attendanceApi = {
  ...
  statsDetail: (params) => request.get('/attendance/stats/detail', { params }),
...
export const groupChatApi = {
  groups: () => request.get('/group-chat/groups'),
  messages: (groupId) => request.get(`/group-chat/${groupId}/messages`),
  send: (groupId, content) => request.post(`/group-chat/${groupId}/send`, { content }, { timeout: 45000 }),
  members: (groupId) => request.get(`/group-chat/${groupId}/members`),
  create: (groupName, memberIds) => request.post('/group-chat/create', { groupName, memberIds }),
  addMembers: (groupId, userIds) => request.post(`/group-chat/${groupId}/add-members`, { userIds }),
  leave: (groupId) => request.post(`/group-chat/${groupId}/leave`),
}
